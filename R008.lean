...
This development is staged. The exact rational certificate data and generic
Bernstein/Delsarte arithmetic are included now. The spherical Gegenbauer
positive-definiteness theorem and the final graph/geometric closure are the
remaining substantive formalization milestones; see `FORMALIZATION_STATUS.md`.
-/
