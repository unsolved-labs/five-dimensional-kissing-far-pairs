...
def generate_lean(tasks_and_pieces):
    lines=["import Mathlib.Data.Rat.Defs","","/-!","# Generated exact R008 Bernstein certificate data","","This file is generated by `certificates/generate_bernstein_certificates.py`.","It contains only exact rational data. The certificate-soundness theorem","belongs in `R008/Bernstein.lean`; no generated declaration is itself a","claim of interval positivity until that checker has compiled.","-/","","set_option autoImplicit false","","namespace R008.Generated","","structure BernsteinPiece where","  left : ℚ","  right : ℚ","  affinePower : List ℚ","  bernstein : List ℚ","  depth : Nat","deriving Repr, DecidableEq","","structure BernsteinCertificate where","  name : String","  degree : Nat","  wantsNegative : Bool","  originalLeft : ℚ","  originalRight : ℚ","  originalPower : List ℚ","  pieces : List BernsteinPiece","deriving Repr, DecidableEq",""]
    cert_names=[]
